            ...
            @if (count($selected) && !$selectAll && !$selectPage)
                <div>
                    ...
                    <button
                        ...
                        type="button"
                        class="ml-1 text-blue-600 underline text-gray-700 text-sm leading-5 font-medium focus:outline-none focus:text-gray-800 focus:underline transition duration-150 ease-in-out dark:bg-gray-700 dark:text-gray-400"
                    >
                        @lang('Unselect All')
                    </button>
                </div>
