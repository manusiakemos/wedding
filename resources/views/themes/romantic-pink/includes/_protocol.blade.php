<section id="protocol" class="py-5 bg-cream">
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <div class="text-center text-dark text-center text-black-50 fs-6">
                    <strong> Dikarenakan situasi pandemi saat ini</strong> <br>
                    <strong> Maka Acara akan dilaksanakan dengan mematuhi</strong> <br>
                    <strong> Protokol Kesehatan </strong>
                </div>
            </div>
        </div>
    </div>
    <div class="container mw-800 py-5" data-aos="slide-up">
        <div class="row d-flex justify-content-center align-items-start" style="flex: 1">
            <div class="col d-flex flex-column justify-content-center align-items-center">
                <img src="{{ asset('/themes/'.$invitation->theme->key.'/images/face-mask.png') }}" alt="face mask" class="rounded-circle img-protocol bg-dark p-3">
