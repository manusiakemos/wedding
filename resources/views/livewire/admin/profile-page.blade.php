        ...
        <x-admin.tabs class="tabs" :headers="$tabHeaders">
            ...
            <x-slot name="edit">
                <form action="#" wire:submit.prevent="updateProfile">
                    ...
                    <div class="py-3 flex">
                        <button class="btn bg-red-400 text-white ml-auto hover:bg-red-500" type="submit">Save Changes
                        </button>
                    </div>
                </form>
            </x-slot>
            ...
            <x-slot name="avatar">
                <form wire:submit.prevent="updateAvatar">
                    ...
                    <div class="py-3 flex">
                        <button class="btn bg-red-400 text-white ml-auto hover:bg-red-500 mt-3" type="submit">Save
                            Changes
                        </button>
                    </div>
                </form>
            ...
            <x-slot name="password">
                <form action="#" wire:submit.prevent="updatePassword">
                    ...
                    <div class="py-3 flex">
                        <button class="btn bg-red-400 text-white ml-auto hover:bg-red-500" type="submit">Save Changes</button>
                    </div>
                </form>
            </x-slot>
        </x-admin.tabs>
